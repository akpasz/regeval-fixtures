...
def build(g) -> dict:
    ...
    claims = [
     ...
     {"id": "AML-S01-C12b", "proposition": f"{payee_sa} has no relationship with the principals of {cust_co} personally.",
      "status": "not_provided", "evidence": [],
      "rationale": "No evidence in the corpus addresses relationships between the payee and the individual principals. Distinct from C12a: the registry speaks to entities, not persons."},
     {"id": "AML-S01-C12c", "proposition": f"Dealings between {cust_co} and {payee_sa} are arm's length commercial trade.",
    ...
    files["scenarios/AML-S01.yaml"] = {
        ...
        "coverage_labels": ["citation", "absence", "ownership", "qualifier",
                            "numerical", "entity_resolution", "claim_decomposition",
