...
## DD-023 Single build entry point
Derived reports were generated by separate commands, which allowed a state in
which scenarios were current and coverage, diversity, or the audit described
